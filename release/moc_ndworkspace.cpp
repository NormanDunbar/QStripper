...
**
** Created: Mon 24. Apr 13:14:37 2006
...
int NDWorkspace::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: tileVertically(); break;
        case 1: tileHorozontally(); break;
        }
        _id -= 2;
    }
    return _id;
