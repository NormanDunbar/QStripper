...
static const char qt_meta_stringdata_MdiChild[] = {
    "MdiChild\0\0Format\0FormatChanged(QTextCharFormat)\0"
...
void MdiChild::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->FormatChanged((*reinterpret_cast< const QTextCharFormat(*)>(_a[1]))); break;
...
// SIGNAL 0
void MdiChild::FormatChanged(const QTextCharFormat & _t1)
{
